// src/components/UpdateUseForSelector.js
  ...
  return (
    <div className="grid w-full gap-4 p-5 rounded-lg bg-[#fff] border border-gray-300 shadow-sm">
      ...
      <div className="flex flex-col w-full">
        ...
        <Select onValueChange={handleUseForChange} value={currentUseFor}>
      ...
      <div className="flex flex-col w-full">
        ...
        <Select onValueChange={handleGenderChange} value={currentGender}>
          <SelectTrigger className="w-full border border-gray-300 bg-[#fff] rounded-lg p-2">
      ...
      <div className="flex flex-col w-full">
        ...
        <Select onValueChange={handleAgeGroupChange} value={currentAgeGroup}>
          <SelectTrigger className="w-full border border-gray-300 bg-[#fff] rounded-lg p-2">
...
export default UpdateUseForSelector;
